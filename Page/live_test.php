    ...
    <body>
        ...
        <header class="ntjoy_header">
            <div align="center" style="color: #ffffff">
                ...
                <a style="color:white;font-size:24px;line-height: 40px">江海明珠网-直播</a>
                <ul class="h_nav">
...
<!--                <a href="dianbo.php"><i class="i i_watch"></i>点播</a>-->
        ...
        <!--流量提醒-->
<!--        <div class="network_environment_alert" style="margin-top: 5px;margin-bottom: 5px;font-size: 14px; color: #fff;text-align: center;background-color: #FFA928;padding: 5px">
            温馨提示：视频费流量，建议在WiFi下观看，土豪请随意。
        </div>-->

        <!--频道列表-->
        <div style="height: 35px;">
            <div style="background: #80c269;float: left;height: 100%;width: 25%;line-height: 35px;" align="center" >
                <a  href="live.php?cid=1" style="color:#fff;font-size: 25px">新闻</a>
            </div>
            <div style="background: #06a7e1;float: left;height: 100%;width: 25%;line-height: 35px;" align="center" >
                <a  href="live.php?cid=2" style="color:#fff;font-size: 25px">都市</a>
            </div>
            <div style="background: #7e73b9;float: left;height: 100%;width: 25%;line-height: 35px;" align="center" >
                <a  href="live.php?cid=3" style="color:#fff;font-size: 25px">影视</a>
            </div>
            <div style="background: #f76a6f;float: left;height: 100%;width: 25%;line-height: 35px;" align="center" >
